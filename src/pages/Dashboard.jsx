            ...
            <div className="p-8 ev-card">
              ...
              <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-3">
                <div className="border-2 ev-stat-card bg-gradient-to-br from-ev-primary-50 to-ev-primary-100 border-ev-primary-200">
                  ...
                  <h3 className="mb-1 text-lg font-bold text-ev-primary-800">Total Bookings</h3>
                  <p className="mb-2 text-3xl font-bold text-ev-primary-600">5</p>
                ...
                <div className="border-2 ev-stat-card bg-gradient-to-br from-ev-energy-400/10 to-ev-energy-500/20 border-ev-energy-400/30">
                  ...
                  <h3 className="mb-1 text-lg font-bold text-ev-energy-800">Active Sessions</h3>
                  <p className="mb-2 text-3xl font-bold text-ev-energy-600">1</p>
                ...
                <div className="border-2 ev-stat-card bg-gradient-to-br from-ev-secondary-50 to-ev-secondary-100 border-ev-secondary-200">
                  ...
                  <h3 className="mb-1 text-lg font-bold text-ev-secondary-800">Available Stations</h3>
                  <p className="mb-2 text-3xl font-bold text-ev-secondary-600">12</p>
      ...
      case 'profile':
        return (
          <div className="p-8 ev-card">
            ...
            {profileError && (
              <div className="flex items-center px-4 py-3 mb-6 space-x-3 text-red-700 border-2 border-red-200 bg-red-50 rounded-xl">
            ...
            {profileSuccess && (
              <div className="flex items-center px-4 py-3 mb-6 space-x-3 border-2 bg-ev-primary-50 border-ev-primary-200 text-ev-primary-700 rounded-xl">
                <svg className="flex-shrink-0 w-5 h-5 text-ev-primary-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="space-y-6">
              <div className="ev-form-group">
                <label className="flex items-center space-x-2 ev-label">
                ...
                {isEditingProfile ? (
                  ...
                  <p className="px-4 py-3 mt-1 font-medium text-gray-900 bg-gray-50 rounded-xl">{user.username}</p>
                )}
              </div>
              ...
              <div className="ev-form-group">
                ...
                {isEditingProfile ? (
                  ...
                  <p className="px-4 py-3 mt-1 font-medium text-gray-900 bg-gray-50 rounded-xl">{user.email}</p>
                )}
              </div>
              ...
              <div className="ev-form-group">
                ...
                {isEditingProfile ? (
                  ...
                  <p className="px-4 py-3 mt-1 font-medium text-gray-900 bg-gray-50 rounded-xl">{user.phone || 'Not provided'}</p>
                )}
              </div>
      ...
      case 'settings':
        return (
          <div className="p-8 ev-card">
            ...
            <p className="text-lg text-gray-600">Manage your account settings and charging preferences.</p>
          </div>
        );
      default:
        return (
          <div className="p-8 text-center ev-card">
            <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-ev-gradient rounded-2xl">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L13.09 8.26L22 9L13.09 9.74L12 16L10.91 9.74L2 9L10.91 8.26L12 2Z"/>
              </svg>
            </div>
            <h3 className="mb-2 text-xl font-semibold text-gray-700">Select a Menu Item</h3>
