                            ...
                            <div className="space-y-3">
                                ...
                                {booking.updatedAt &&
                                    booking.updatedAt !== booking.createdAt && (
                                        <div className="flex items-center space-x-3">
                                            <div
                                                className={`w-3 h-3 rounded-full ${booking.status === "Approved"
                                                        ? "bg-green-500"
                                ...
                                <div className="flex items-center space-x-3">
                                    <div
                                        className={`w-3 h-3 rounded-full ${new Date(booking.reservationTime) > new Date()
                                                ? "bg-gray-300"
                                                : "bg-orange-500"
                                            }`}
                                    ></div>
                        ...
                        <div className="p-4 rounded-lg bg-yellow-50">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span
                                        className={`text-sm ${booking.qrCodeBase64 ? "text-green-600" : "text-red-600"
                                            }`}
                                    >
